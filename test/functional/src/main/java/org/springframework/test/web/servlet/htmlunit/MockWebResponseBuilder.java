...
/**
 * Copied from spring-test 4.2.0.RELEASE
...
final class MockWebResponseBuilder {
    ...
    private List<NameValuePair> responseHeaders() {
        ...
        for (Cookie cookie : cookies) {
            responseHeaders.add(new NameValuePair("Set-Cookie", cookieHeaderValue(cookie)));
        }
        //CHANGE END
    ...
    //CHANGE START
    private String cookieHeaderValue(Cookie cookie) {
